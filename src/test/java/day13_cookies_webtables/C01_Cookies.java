...
public class C01_Cookies extends TestBase {
    ...
    public void cookiesTesti() {
       ...
       Set<Cookie> cookiesSet = driver.manage().getCookies();
        ...
        //6-eklediginiz cookinin sayfaya eklendigini test edin
        Assert.assertTrue(cookiesSet.contains(cookie));


        //7-ismi skin olan cookieyi silin ve silindigini test edin
        driver.manage().deleteCookieNamed("skin");
        Assert.assertFalse(cookiesSet.contains("skin"));


        //8-tum cookieleri silin ve silindigini test edin
